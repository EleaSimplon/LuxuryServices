 ...
 */
final class Version20210608075443 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job_offer CHANGE id id VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job_offer CHANGE id id INT AUTO_INCREMENT NOT NULL');
    }
}
